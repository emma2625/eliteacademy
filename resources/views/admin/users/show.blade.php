        ...
        <form method="POST" action="{{ route('profile.update') }}" class="row" enctype="multipart/form-data">
            ...
            <div class="col-md-4 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    @if (Auth::user()->avatar)
                        <img class="rounded-circle mt-5 object-fit-cover border" width="150px" height="150px" src="{{ asset(Auth::user()->avatar) }}">
                    @else
                        <img class="rounded-circle mt-5 object-fit-cover border" width="150px" height="150px" src="{{ asset('profile.jpg') }}">
                    @endif
